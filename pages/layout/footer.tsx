        ...
        <div className="container-fluid">
            <div className="row">
                <div className="col-lg-4 col-xs-12 pb-sm-4 ">
                    <div className="col-12 primero">
                        <h3>Derechos Reservados</h3>
                        <a href="">Términos y Condiciones</a>
                    </div>
                </div>
                <div className="col-lg-4 col-xs-12 text-center">
                    <div className="col-12 segundo">
                ...
                <div className="col-lg-4 col-xs-12">
                    <div className="col-12 tercero">
                        <h3>Contactanos</h3>
                        <ul>
                            <li><b>Telefono: </b>01 2883829</li>
                            <li><b>Correo : </b>pasteleriamila@gmail.com</li>
                        </ul>
                    </div>
                </div>
            </div>
